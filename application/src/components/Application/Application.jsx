    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                ...
                "https://pmsss-backend-jb0n.onrender.com/application/apply",
                {
                    method: "POST",
                    headers: {
    ...
    return (
        <div className="formcontainer">
                ...
                <div className="row">
                    <div className="input-group">
                        ...
                        <input
                            ...
                            value={
                                applicationData.Name_of_qualifying_public_examination
                            }
                            onChange={handleInput}
                        />
                    </div>
            ...
            examination for Scholarship">
                        Roll Number of last eligible
                        Board/Council/College/University examination for
                        Scholarship
                    </label>
                    <input
                        type="text"
            ...
            Examination">
                        Passing Year Of Standard
                        Board/Council/College/University Examination
                    </label>
                    <input
                        type="year"
                ...
                <div className="row">
                    <div className="input-group">
                        <label htmlFor="Total marks obtained">
                    ...
                    <div className="input-group">
                        <label htmlFor="Overall percentage(%)">
                            Overall percentage(%)
                        </label>
                        <input
                            type="text"
                ...
                <p className="notation">
                    <span style={{ color: "red" }}>*</span> Details of Last
                    Eligible Qualifying Board/Council/College/University
                    Examination for Scholarship
                </p>
                <hr className="bar" />
                ...
                <div className="row">
                    <div className="input-group">
                        <label htmlFor="Discipline of Course">
                    ...
                    <div className="input-group">
                        <label htmlFor="Date Of Admission">
                            Date Of Admission
                        </label>
                        <input
                            type="date"
              ...
              from JAN,2024)">
                            Total income of family(in rupees,from all sources
                            for the period from JAN,2024)
                        </label>
                        <input
                            type="text"
                ...
                <p className="notation">
                    <span style={{ color: "red" }}>*</span> Present Course of
                    Study
                </p>
                <hr className="bar" />
                ...
                <div className="input-group2">
                    ...
                    />
                    <p className="notation">
                        <span style={{ color: "red" }}>*</span> Size Less Than
                        60 kb
                    </p>
                </div>
                <p className="notation">
                ...
                <div className="row">
                    <div className="input-group2">
                        ...
                        />
                        <p className="notation">
                            <span style={{ color: "red" }}>*</span> Size Less
                            Than 60 kb
                        </p>
                    </div>
                    <div className="input-group2">
                ...
                <div className="row">
                    <div className="input-group2">
                        ...
                        <input
                            ...
                            value={
                                applicationData.Upload_Mark_sheet_Last_qualifying_exam
                            }
                            onChange={handleInput}
                        />
                        <p className="notation">
                ...
                <button
                    ...
                    style={{
                        ...
                        color: "white",
                        background:
                            "linear-gradient(to bottom,  #EFB506, #FFC107)",
                        borderRadius: "8px",
                    }}>
                    Submit
                </button>
